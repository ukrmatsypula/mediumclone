...
export const mutationTypes = {
  createArticleStart: '[createArticleStart] createArticleStart',
  createArticleSuccess: '[createArticleSuccess] createArticleSuccess',
  createArticleFailure: '[createArticleFailure] createArticleFailure',
}

export const actionTypes = {
  createArticle: '[craeteArticle] createArticle',
}
